...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export a markdown recovery plan for a Wannier90 working directory.")
    ...
    record = build_recommendation(source, args.seedname)
